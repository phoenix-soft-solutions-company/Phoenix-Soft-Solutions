...
const Navbar = () => {
  ...
  return (
    <>
      {/* Space above the navbar with text */}
      <div className="bg-white text-center py-4">
        <p className="text-lg font-semibold text-gray-700">
          Welcome to Xcrop's Official Website
        </p>
      </div>

      {/* Navbar */}
      <nav className="bg-red-800 text-white py-4 px-10 fixed left-0 top-[80px] right-0 z-[1000]">
