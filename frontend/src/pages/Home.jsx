    ...
    <div className="">
      ...
      <div className="flex flex-col lg:flex-row md:py-10 xl:px-20">
        <div className="w-full lg:w-1/2 xl:1/3 flex justify-center items-center relative">
          <div className="p-4 border-l-2 border-t-2 border-black rounded-full relative">
            <div className="p-4 border-r-2 border-b-2 border-black rounded-full relative">
              <img src={Logo} alt="Description" className="w-64 h-64 sm:w-96 sm:h-96 rounded-full" />
              <div className="z-[100] px-4 py-2 rounded-sm absolute top-[380px] left-[80px] items-center space-x-4 hidden sm:flex bg-gradient-to-r from-blue-400 to-purple-500">
                {/* Social Media Icons */}
                <a
              ...
              <div className="ballLeft absolute top-0 left-0 hidden sm:flex" />
            </div>
            <div className="ballRight absolute top-0 left-0 hidden sm:flex" />
          </div>
        </div>
      ...
      <div className="flex flex-col justify-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mx-auto px-2 cursor-defalt">
          <div className="bg-white p-4 m-2 rounded shadow-lg max-w-[400px] transform transition-colors duration-300 hover:bg-red-200 hover:border-red-700 border border-transparent">
            ...
            <p className="text-lg">
              To help businesses successfully communicate with their intended demographic, Phoenix Soft
              Solutions provides services that include the complete spectrum of the software development life
              cycle.
            </p>
          </div>
          ...
          <div className="bg-white p-4 m-2 rounded shadow-lg max-w-[400px] transform transition-colors duration-300 hover:bg-red-200 hover:border-red-700 border border-transparent">
            ...
            <p className="text-lg">
              By utilizing Phoenix Soft Solutions's services, businesses can leverage our expertise and
          ...
          <div className="bg-white p-4 m-2 rounded shadow-lg max-w-[400px] transform transition-colors duration-300 hover:bg-red-200 hover:border-red-700 border border-transparent">
            ...
            <p className="text-lg">
              Phoenix Soft Solutions offers thorough testing and bug-fixing to improve overall performance and
