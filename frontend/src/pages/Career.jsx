    ...
    <div className="min-h-screen relative ">
      <header className="relative w-full h-[40vh] md:h-[50vh]">
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 text-white">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold tracking-widest">CAREER</h1>
        </div>
      </header>
          ...
          <div className="flex flex-col lg:flex-row gap-y-6 lg:gap-y-0 lg:gap-x-10">
            <div className="w-full lg:w-1/2">
              <ul className="list-none space-y-4 md:space-y-6 text-sm sm:text-base md:text-lg text-black">
                {["How we play", "We're in this together", "Bring your best"].map((title, index) => (
                  <li
                    key={index}
                    ...
                    <div>
                      ...
                      <p>
                        {index === 0 && "It's important to know that what matters to us also matters to you."}
                        {index === 1 &&
            ...
            <div className="w-full lg:w-1/2">
              <ul className="list-none space-y-4 md:space-y-6 text-sm sm:text-base md:text-lg text-black">
                {["Be a pioneer", "Ask Why?", "Be ready to help"].map((title, index) => (
                  <li
                    key={index}
                    className="flex items-start transform transition-transform duration-300 hover:translate-x-2">
                    <FontAwesomeIcon
      ...
      <section className="p-6 md:p-8 bg-gray-100 text-black flex flex-col items-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-6 md:mb-8 text-center">OUR BENEFITS</h1>
          ...
          {[
            {
              ...
              description:
                "Success at Phoenix Soft Solutions means you'll always be facing new challenges - which means you're learning and empowered to overcome your current challenges. To facilitate learning, we provide coaches and learning tracks through our Phoenix Soft Solutions Academy program. Our current learning tracks include: Product Discovery, Tech Practices, Agile Facilitation, Product Management and People Leadership. Plus, there are plenty of opportunities to showcase your skills to your VPT and others at Phoenix Soft Solutions through our weekly CoPX experience discussions, fortnightly lunch presentations and cross-team huddles.",
              imgSrc: card1,
              imgAlt: "Learning opportunities",
            },
            {
              title: "Create impactful software and share in the financial upside",
              description:
                "At Phoenix Soft Solutions, we love building impactful and purposeful software for our customers. Our customers are building SaaS businesses and the awesome thing about SaaS is that when you are creating an impact for good, then scaling the business also scales the impact. Phoenix Soft Solutions Ventures is our team ESOP, giving everyone who works at Phoenix Soft Solutions a chance to own shares in our customers. So when our customers win, we not only take pride in knowing we’ve achieved an awesome impact, but we share in the financial upside.",
              imgSrc: card2,
            ...
            },
            {
              ...
              description:
                "Our Virtual Product Teams are a core feature of Phoenix Soft Solutions. We value collaboration and co-working, and as part of a VPT, you'll have access to, and be supported by other talented people who are passionate about the success of our partners and Phoenix Soft Solutions.",
              imgSrc: card3,
            ...
            <div
              ...
              <div className="w-full md:w-1/2 mb-4 md:mb-0 ">
                <h3 className="text-xl md:text-2xl font-semibold mb-4 text-red-600">{card.title}</h3>
                <p>{card.description}</p>
              </div>
              <div className="w-full md:w-1/2">
                <img src={card.imgSrc} alt={card.imgAlt} className="rounded-lg object-cover w-full h-full" />
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center mb-8">
        <div className="w-full mb-4">
          <img src={card1} alt="Open positions" className="rounded-lg object-cover w-full h-48 md:h-64" />
        </div>
        <div className="w-full text-center">
          <h3 className="text-xl md:text-2xl font-semibold mb-4 text-red-600">Apply to our open positions</h3>
          <p>
            Create your own role. We’re always on the lookout for talented people to join the growing team at
            Phoenix Soft Solutions. Is it you?
          </p>
        </div>
        <div className="mt-6">
          <a
      ...
      <section className="p-6 md:p-8 bg-white text-black flex flex-col items-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-6 md:mb-8 text-center">FAQ</h1>

        <div className="max-w-4xl w-full space-y-4 md:space-y-6">
          {[
            {
              question: "I want to learn and develop. Will Phoenix Soft Solutions support me?",
              answer:
                "Yes, Phoenix Soft Solutions is committed to your professional development. We offer various learning opportunities through our Phoenix Soft Solutions Academy program, including coaching, learning tracks, and regular knowledge-sharing sessions.",
            },
            {
              question: "What sort of tech stack is used at Phoenix Soft Solutions?",
              answer:
            ...
            {
              question: "How does Phoenix Soft Solutions implement and practice Agile?",
              answer:
            ...
            {
              question: "What sort of people and skillsets typically work for Phoenix Soft Solutions?",
              answer:
            ...
            <div key={index} className="bg-gray-100 p-4 rounded-lg shadow-md mb-4">
              <h3 className="text-xl md:text-2xl font-semibold mb-2 text-black-600">{faq.question}</h3>
              <p>{faq.answer}</p>
            </div>
          ))}
        </div>
