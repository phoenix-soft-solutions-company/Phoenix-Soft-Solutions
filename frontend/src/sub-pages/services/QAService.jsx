    ...
    <div className="min-h-screen relative">
      ...
      <div className="flex flex-col items-center justify-center px-4 py-12">
        ...
        <div className="text-center mb-8">
          <p className="mb-4">
            “Two of our many essential service categories are QA and Software Testing services, which are
            meant to <br /> ensure that the software meets all of its standards and expectations before it is
            released.
          </p>
          <p className="mb-4">
            This guarantee contributes significantly to the success of the software in the future. In order to
            assist our
            <br /> clients in delivering high-quality software in a timely manner, we offer comprehensive
            quality assurance
        ...
        <p className="mb-4 text-center mt-8">
          The customizable service model offered by Phoenix Soft Solutions includes web app/ mobile app and
          custom app testing. With
          <br /> ten years of experience in the worldwide IT market - especially for QA testing software, we
          have numerous non-tech
          <br /> and tech company clients from key nations such as the United States, Canada, the United
          Kingdom, Australia, Germany, and the
          <br /> Netherlands… to seek guidance on appropriate software solutions; and have subsequently opted
        ...
        <div className="w-full max-w-4xl text-center mt-12">
          <h1 className="text-2xl lg:text-3xl font-serif font-bold mb-4">OUR COMMITMENT TO EXCELLENCE</h1>
      ...
      <div className="relative bg-red-600 text-white py-16">
        ...
        <div className="relative z-10 text-center px-4 lg:px-8">
          ...
          <p className="text-lg mb-6 text-black">
            Contact us today to enhance your business with our expert Software QA Testing services and
            solutions. Let’s work together to ensure your software performs flawlessly and meets the highest
            quality standards.
          </p>
