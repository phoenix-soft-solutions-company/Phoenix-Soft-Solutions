    ...
    <div className="min-h-screen relative pt-16">
      ...
      <div className="flex flex-col items-center justify-center px-4 py-8">
        ...
        <p className="text-lg text-center mb-8 max-w-2xl">
          An excellent data storage solution with<br></br> Saigon Technology - high-profile cloud migration
          services vendor in Vietnam
        </p>
      ...
      <div className="flex flex-col items-center justify-center px-4 py-8">
        ...
        <p className="text-lg text-center max-w-2xl">
          ...
          <br></br> consulting, Saigon Technology will perform the following steps:
        </p>
      </div>
        ...
        <div className="w-full md:w-1/2 p-4">
          <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-lg h-full">
            ...
            <p className="text-center">
              After receiving the ideas and business requests from the client, Saigon Technology's Developers
              team will conduct analysis to capture and understand the current state of corporate architecture
              data. Analyze the current architecture, understand the business needs and prioritize
              applications to switch. Another important task is the cost assessment, we will consider based on
              the system of subjective as well as objective factors to come up with the right price.
            </p>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 p-4">
          <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-lg h-full">
            ...
            <p className="text-center">
              ...
              process becomes easier and faster. After successful transfer, Saigon Technology team will train
              customers on how to use and handle situations when using the service. From there, we will carry
              out product handover and maintain regular repairs and maintenance to ensure everything is under
              control.
            </p>
          </div>
        </div>
