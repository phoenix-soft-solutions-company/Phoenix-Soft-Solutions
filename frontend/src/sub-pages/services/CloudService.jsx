    ...
    <div className="min-h-screen relative ">
      ...
      <div className="flex flex-col items-center justify-center px-4 py-8">
        ...
        <p className="text-lg text-center mb-8 max-w-2xl">
          An excellent data storage solution with<br></br> Phoenix Soft
          Solutions - high-profile cloud migration services vendor in Australia
        </p>
        <img
          src={service1}
      ...
      <div className="flex flex-col items-center justify-center px-4 py-8">
        ...
        <p className="text-lg text-center max-w-2xl text-justify">
          After receiving comments and requests from customers and conducting
          appropriate cloud migration consulting, Phoenix Soft Solutions will
        ...
        <div className="w-full md:w-1/2 p-4">
          <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-lg h-full">
            ...
            <p className="text-justify">
              ...
              Phoenix Soft Solutions's Developers team will conduct analysis to
        ...
        <div className="w-full md:w-1/2 p-4">
          <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-lg h-full">
            ...
            <p className="text-justify">
              ...
              After successful transfer, Phoenix Soft Solutions team will train
