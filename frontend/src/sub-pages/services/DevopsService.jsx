    ...
    <div className="min-h-screen relative pt-16">
      ...
      <div className="p-8 lg:p-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg lg:text-xl">
            As a long-standing DevOps Services Company, Phoenix Soft Solutions
            offers high-quality and affordable DevOps consulting and
      ...
      <div className="text-center mb-12">
        ...
        <div className="text-center mb-12 mt-11 bg-gray-100">
          <h1 className="text-3xl lg:text-4xl font-bold uppercase ">
            Taking Advantage of Partnering with Phoenix <br></br> Soft
            Solutions for DevOps Services
          </h1>
          <img
            src={devops2}
