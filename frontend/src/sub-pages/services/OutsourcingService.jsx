    ...
    <div className="min-h-screen relative pt-16">
      ...
      <div className="flex flex-col lg:flex-row items-start mt-12 mx-8 lg:mx-24">
        ...
        <div className="w-full lg:w-1/2 lg:pl-12 space-y-4">
          <p className="flex items-start text-lg">
            ...
            Saigon Technology has one goal: your success is our mission! We are a top software outsourcing
            company with over 12 years of experience. We have completed over 800 projects in many areas. This
      ...
      <div className="flex flex-col items-center py-8">
        ...
        <p className="text-gray-700 text-center max-w-2xl">
          Choose Saigon Technology for your software development. We promise top-quality results at a lower
          cost. Our approach ensures a smooth process from start to finish. Enjoy a stress-free experience as
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded shadow-lg">
            ...
            <p className="text-gray-700">
              ...
              Switzerland, and Singapore. Saigon Technology’s developers are fluent in English and understand
              various cultural nuances. This makes the team ideal for any project.
            </p>
          </div>
