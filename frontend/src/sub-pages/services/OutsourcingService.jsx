        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded shadow-lg">
            ...
            <p className="text-gray-700">
              ...
              include the US, Australia, UK, Switzerland, and Singapore. Phoenix
              Soft Solutions’s developers are fluent in English and understand
              various cultural nuances. This makes the team ideal for any
              project.
            </p>
          </div>
