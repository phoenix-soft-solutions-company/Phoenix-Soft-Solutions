    ...
    <div className="min-h-screen relative ">
      ...
      <div className="flex flex-col lg:flex-row items-start mt-12 mx-8 lg:mx-24">
        ...
        <div className="w-full lg:w-1/2 lg:pl-12 space-y-4">
          <p className="flex items-start text-lg text-justify">
            <FontAwesomeIcon
              icon={faCheckCircle}
              className="text-red-600 text-xl mr-2 mt-1 "
            />
            Phoenix Soft Solutions has one goal: your success is our mission! We
            are a top software outsourcing company with over 12 years of
            experience. We have completed over 800 projects in many areas. This
            means we keep up with tech changes.
          </p>
          <p className="flex items-start text-lg text-justify">
            <FontAwesomeIcon
              icon={faCheckCircle}
      ...
      <div className="flex flex-col items-center py-8">
        ...
        <p className="text-gray-700 text-center max-w-2xl">
          Choose Phoenix Soft Solutions for your software development. We
          promise top-quality results at a lower cost. Our approach ensures a
          smooth process from start to finish. Enjoy a stress-free experience as
          we handle your needs.
        </p>
      </div>
      ...
      <div className="p-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded shadow-lg">
            ...
            <p className="text-gray-700 text-justify">
              Software development can be pricey in the US and Europe. But,
              outsourcing developers from Vietnam offers a budget-friendly
              option. We charge between $30 and $49 per hour, based on the
              services you choose. You get expert solutions every time, no
              matter the price or place.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded shadow-lg">
            ...
            <p className="text-gray-700 text-justify">
              We use agile principles to stay swift and responsive with
              outsourcing software development. This style shapes our
              client-focused approach. It supports ongoing improvements and
              suits changing needs and market shifts.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded shadow-lg">
            ...
            <p className="text-gray-700 text-justify">
              We hold ISO 9001 and ISO/IEC 27001 certificates. These ensure top
              quality. It means secure information handling in software
              outsourcing and development. No matter the project's complexity,
              we maintain quality at every stage.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded shadow-lg">
            ...
            <p className="text-gray-700 text-justify">
              Our use of cutting-edge technology and AI keeps us up-to-date. We
              adopt the latest methods to meet the demands of the digital age.
              This ensures your product gets the newest solutions, giving you a
              market advantage.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded shadow-lg">
            ...
            <p className="text-gray-700 text-justify">
              Our team has completed numerous projects worldwide. The locations
              include the New Zealand, Australia, UK, Sweden, and Sri Lanka.
              Phoenix Soft Solutions’s developers are fluent in English and
              understand various cultural nuances. This makes the team ideal for
              any project.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded shadow-lg">
            ...
            <p className="text-gray-700 text-justify">
              We ensure timely delivery with our outsourcing software
              development services. We do this by assigning an experienced
              Project Manager and a Tech Lead to each project. You will meet
              these key team members before we start working on your project.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="relative bg-red-600 text-white py-16">
        ...
        <div className="relative z-10 text-center px-4 lg:px-8">
          ...
          <p className="text-lg mb-6 text-black">
            ...
            development outsourcing services. Let’s collaborate to build
