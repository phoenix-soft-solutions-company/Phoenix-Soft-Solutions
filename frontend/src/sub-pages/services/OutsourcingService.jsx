    ...
    <div className="min-h-screen relative">
      ...
      <div className="flex flex-col items-center py-8">
        ...
        <p className="text-gray-700 text-center max-w-2xl">
          Choose Saigon Technology for your software development. We promise
          top-quality results at a lower cost. Our approach ensures a smooth
          process from start to finish. Enjoy a stress-free experience as we
          handle your needs.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded shadow-lg">
            ...
            <p className="text-gray-700">
              ...
              include the US, Australia, UK, Switzerland, and Singapore. Saigon
              Technology’s developers are fluent in English and understand
