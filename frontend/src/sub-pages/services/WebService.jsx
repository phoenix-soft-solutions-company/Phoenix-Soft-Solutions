      ...
      <div className="flex flex-col lg:flex-row justify-center items-center p-5 gap-5 lg:gap-x-20 xl:gap-x-40">
        <div className="w-full lg:w-1/2 max-w-2xl lg:max-w-xl bg-gray-100 p-6 rounded-lg border-2 border-red-500 shadow-md">
          <p className="text-xl leading-relaxed flex items-start">
            ...
            Phoenix Soft Solutions stands at the forefront as a distinguished web application development
            company, boasting a rich legacy of over 12 years in the industry. Our voyage through the realms of
            web development is consistently marked by the benefits of unwavering allegiance to the Agile
            Mindset, crafting tailor-made solutions that range from nurturing startup ventures to developing
            complex, multi-faceted systems for substantial corporate entities.
          </p>
        </div>
