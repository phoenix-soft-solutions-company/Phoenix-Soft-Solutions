  ...
  return (
    <div className="min-h-screen ">
      ...
      <div className="relative w-full h-[50vh]">
        <img src={service} className="object-cover w-full h-full" alt="Frontend Development" />
      ...
      <div className="py-8 px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg flex flex-col items-center text-center mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-semibold mb-2">UI/UX Design</h2>
          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg flex flex-col items-center text-center mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-semibold mb-2">Front-End Web Development with React</h2>
            <p className="text-sm sm:text-base">
          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg flex flex-col items-center text-center mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-semibold mb-2">Front-end Development with Angular</h2>
            <p className="text-sm sm:text-base">
          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg flex flex-col items-center text-center mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-semibold mb-2">Front-end Development with Vue.js</h2>
            <p className="text-sm sm:text-base">
          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg flex flex-col items-center text-center mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-semibold mb-2">HTML & CSS Responsive Web Design</h2>
            <p className="text-sm sm:text-base">
          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg flex flex-col items-center text-center mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-semibold mb-2">CMS Theming</h2>
            <p className="text-sm sm:text-base">
          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg flex flex-col items-center text-center mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-semibold mb-2">Single-Page Applications</h2>
            <p className="text-sm sm:text-base">
          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg flex flex-col items-center text-center mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-semibold mb-2">Progressive Web Applications (PWAs)</h2>
            <p className="text-sm sm:text-base">
              Saigon Technology creates PWAs that offer a native app-like experience while running on the web.
              With offline access, push notifications, and performance optimizations, PWAs deliver an engaging
              and reliable user experience, fostering higher user retention and satisfaction.
            </p>
          </div>
        </div>
      </div>
