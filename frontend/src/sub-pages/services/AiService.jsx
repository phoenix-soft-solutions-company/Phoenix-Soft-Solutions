    ...
    <div className="min-h-screen relative pt-16">
      ...
      <div className="flex flex-col items-center mt-10 px-4">
        ...
        <p className="text-md text-justify px-8 mx-10 mb-6">
          Saigon Technology - a prominent solutions and software development company in Vietnam, specializes
          in providing corporate technology solutions that use Artificial Intelligence (AI) and Machine
          Learning (ML).
        ...
        <div className="flex flex-col lg:flex-row items-center w-full max-w-5xl px-4 mb-6">
          ...
          <div className="flex flex-col w-full lg:w-1/2">
            <p className="text-lg text-justify mb-4">
              Saigon Technology, headquartered in Ho Chi Minh City, Vietnam, and with representative offices
              in Singapore and the United States, provides a broad range of qualified technical expertise in
              machine learning, deep learning, computer vision, classification tools, data analytics, natural
              language processing, and other areas.
            </p>
            <p className="text-lg text-justify">
              If you're looking for an AI development firm in Vietnam, we've got a team of data scientists,
