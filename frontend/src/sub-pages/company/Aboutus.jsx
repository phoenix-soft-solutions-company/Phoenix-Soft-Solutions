    ...
    <div className="min-h-screen relative ">
      ...
      <div className="flex flex-col lg:flex-row p-4 md:p-8">
        ...
        <div className="lg:w-1/2 lg:pl-8 mt-8 lg:mt-0">
          ...
          <p className="mb-4 text-sm sm:text-md lg:text-lg text-justify">
            Phoenix Soft Solutions is one of the reputed and leading IT
            companies of Australia. We provide next-generation digital services
            that look great and are easy to use, helping our clients grow their
            businesses successfully. As a result, in just a few years, the
            company has served more than 150+ customers, demonstrating a strong
            reputation for building websites and software.
          </p>
          <p className="mb-4 text-sm sm:text-md lg:text-lg text-justify">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="w-full">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-justify">
                "Our vision is to satisfy our clients with our Phoenix Soft
                Solutions and to be recognized as an all-time preferred IT
                company with complete reliability & authenticity."
              </p>
            </div>
            ...
            <div className="w-full">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-justify">
                "Our mission is to provide the best services at the best price,
                to develop and maintain the bond between client and company to
                grow together."
              </p>
            </div>
            ...
            <div className="w-full">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-justify">
                ...
                values, which leads the whole team towards the company's
                vision-mission. Our core values support and shape the company's
                culture and motivate our employees to achieve their goals."
              </p>
            </div>
          </div>
        </div>
