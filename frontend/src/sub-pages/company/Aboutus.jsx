    ...
    <div className="min-h-screen relative ">
      ...
      <div className="flex flex-col lg:flex-row p-4 md:p-8">
        ...
        <div className="lg:w-1/2 lg:pl-8 mt-8 lg:mt-0">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-lg sm:text-xl md:text-2xl font-bold">About Company</h2>
          </div>
          ...
          <h1 className="mb-4 lg:mb-10 font-bold">
            ...
            <span className="text-red-800 text-2xl sm:text-3xl lg:text-5xl xl:text-6xl">IT </span>
            <br />
            <span className="text-red-800 text-2xl sm:text-3xl lg:text-5xl xl:text-6xl">Solution</span>
            <span className="text-red-600 text-xl sm:text-2xl lg:text-4xl xl:text-5xl"> services</span>
          </h1>
          ...
          <p className="mb-4 text-sm sm:text-md lg:text-lg">
            ...
            next-generation digital services that look great and are easy to use, helping our clients grow
            their businesses successfully. As a result, in just a few years, the company has served more than
            150+ customers, demonstrating a strong reputation for building websites and software.
          </p>
          <p className="mb-4 text-sm sm:text-md lg:text-lg">
            Every company wants satisfactory success, and that is only possible when its clients are
            satisfied. Thus, we focus on providing customized and quality products that always give the best
            results to our customers. We have teams that always use the latest technologies and tools to
            fulfill clients' requirements precisely.
          </p>
      ...
      <div className="flex flex-col-reverse xl:flex-row-reverse gap-2 xl:gap-10 p-4 md:p-8 bg-gray-100 mt-2 lg:mt-8">
        <div className="xl:w-1/2 mb-8 md:mb-0">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">VISION & MISSION</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="w-full">
              ...
              <p className="text-base sm:text-lg lg:text-xl">
                "Our vision is to satisfy our clients with our Phoenix Soft Solutions and to be recognized as
                an all-time preferred IT company with complete reliability & authenticity."
              </p>
            </div>
            ...
            <div className="w-full">
              ...
              <p className="text-base sm:text-lg lg:text-xl">
                "Our mission is to provide the best services at the best price, to develop and maintain the
                bond between client and company to grow together."
              </p>
            </div>
            ...
            <div className="w-full">
              ...
              <p className="text-base sm:text-lg lg:text-xl">
                ...
                towards the company's vision-mission. Our core values support and shape the company's culture
