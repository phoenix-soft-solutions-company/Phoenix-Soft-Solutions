      ...
      <div className="flex flex-col lg:flex-row p-4 md:p-8">
        ...
        <div className="lg:w-1/2 lg:pl-8 mt-8 lg:mt-0">
          ...
          <p className="mb-4 text-md lg:text-lg">
            ...
            services that look great and are easy-to-use which helps our clients
            to grow their business successfully. As a result, just in few years,
            the company has served more than 150+ customers which shows that we
            have made a strong reputation for building websites and software.
          </p>
          <p className="mb-4 text-md lg:text-lg">
